                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            <form action="{{route('admin/edit-store-slider', $data->slider_id)}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Enter Title" value="{{$data->title}}"></input>
                                        @error('title')
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="description" id="description"
                                            placeholder="Enter Description" value="{{$data->description}}"></input>
                                        @error('description')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-4">
                                            <img class="img-fluid" style="width: 200px;"
                                                src="{{asset($data->bg_image)}}" alt="image">
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-2">
